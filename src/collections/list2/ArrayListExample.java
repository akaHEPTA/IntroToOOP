...
public class ArrayListExample {
    public static void main(String[] args) {
        ...
        // 2. size(): get the length of the list
        ...
        // 6. set(i, newObj): set the obj at index i to new obj and returns the old obj.
        System.out.println(countries.set(0, "New Zealand"));

        // 7. remove(obj): remove the obj from the list and returns whether the obj was removed or not. (boolean)
        countries.remove("New Zealand");
        System.out.println(countries);

        // 8. remove(i): remove the obj at index i from the list
        //             : expensive!
        //             : we have to create a new list to copy all elements except for the removed object
        countries.remove(0);

        // 9. contains(obj): check if the obj is in the list. (boolean)
        countries.contains("Canada");

        // 10. clear(): clears the lists. (remove all objects)
        countries.clear();

        // Returns 'List' type
        // List (interface) -> ArrayList (class, implementation)
        List<String> foodList = Arrays.asList("Hot pot", "Sushi", "Taco");
        // We need to create an ArrayList object with the list.
